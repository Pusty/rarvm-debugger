...
#define   MCopyright         "\nRAR %s   Copyright (c) 1993-%d Alexander Roshal   %d %s %d (Modified)"
#define   MRegTo             "\nRegistered to %s\n"
#define   MShare             "\nTrial version             Type RAR -? for help\n"
#define   MUCopyright        "\nUNRAR %s freeware      Copyright (c) 1993-%d Alexander Roshal (Modified)\n"
#define   MBeta              "beta"
...
#define   MCHelpSwTRACE      "\n  trace         Trace executed RarVM instructions"
#define   MCHelpSwDUMP       "\n  dump          Dump all loaded RarVM instructions without execution"
#define   MCHelpSwDIAGNOSTIC "\n  diagnostic    Print out diagnostic information regarding the RarVM settings"
#define   MBadArc            "\nERROR: Bad archive %s\n"
